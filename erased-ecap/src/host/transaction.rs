...
impl<H: ecap::host::Host> ecap::host::Transaction<dyn crate::host::Host> for dyn Transaction<H> {
    fn virgin(&mut self) -> &mut Box<dyn Message> {
        unimplemented!()
    }
    fn cause(&mut self) -> &Box<dyn Message> {
        unimplemented!()
    }
    fn adapted(&mut self) -> &mut Box<dyn Message> {
        unimplemented!()
    }
    fn use_virgin(&mut self) {
...
impl<H: ecap::host::Host> ecap::host::Transaction<H> for dyn Transaction<H>
where
    H: ?Sized,
    H::Message: 'static,
{
    fn virgin(&mut self) -> &mut H::Message {
        ...
        dynamic.downcast_mut::<H::Message>().unwrap()
    }
    fn cause(&mut self) -> &H::Message {
        let dynamic = Self::cause(self);
        dynamic.downcast_ref::<H::Message>().unwrap()
    }
